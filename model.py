...
parser.add_argument("--agents", const=100, type=int, help="Max number of concurrent agents in the model")
parser.add_argument("--kernel", type=str, help="Selected turning kernel")
parser.add_argument("--max-time", conts=1000, type=int, help="Max simulation time our model will run")
parser.add_argument("--tao", const=10, type=int, help="Max trail length")
